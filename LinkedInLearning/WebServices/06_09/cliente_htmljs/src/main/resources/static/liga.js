...
function verEquipos() {
    ...
    xhttp.open("GET", "http://localhost:8085/demo/equipos", true);
    xhttp.send();
}
...
function verEquipo() {
    ...
    xhttp.open("GET", "http://localhost:8085/demo/equipos/" + idEquipo, true);
    xhttp.send();
}
...
function crearEquipo() {
    ...
    xhttp.open("POST", "http://localhost:8085/demo/equipos?id=" + idEquipo + "&nombre=" + nombre, true);
    xhttp.send();
}
...
function modificarEquipo() {
    ...
    xhttp.open("PUT", "http://localhost:8085/demo/equipos/" + idEquipo, true);
...
function anadirJugador() {
    ...
    xhttp.open("PUT", "http://localhost:8085/demo/equipos/" + idEquipo + "/" + idJugador, true);
    xhttp.send();
}
...
function borrarEquipo() {
    ...
    xhttp.open("DELETE", "http://localhost:8085/demo/equipos/" + idEquipo, true);
    xhttp.send();
}
