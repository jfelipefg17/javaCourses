...
public class SecondExampleApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Flux.just(new Product("Tv samsung", 456.76),
						new Product("Iphone 15", 45.76),
						new Product("huawei", 56.6),
						new Product("Apple watch", 46.7),
						new Product("Airpots pro", 6.76),
						new Product("Tv sony", 46.06),
						new Product("Bose speaker", 446.65),
						new Product("Alexa", 69.6)
		)
						.flatMap(product -> {
